namespace Selu383.SP26.Api.Features.Items
{
    public class MenuItem
    {
        ...
        // Navigation property for the many-to-many relationship with User favorites
        public virtual ICollection<Auth.User> FavoriteByUsers { get; set; } = new List<Auth.User>();
    }
}